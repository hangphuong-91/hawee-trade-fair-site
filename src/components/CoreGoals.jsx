        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <FadeUp className="lg:col-span-3">
            <div className="relative overflow-hidden bg-gradient-hawee rounded-2xl p-8 md:p-10 h-full card-hover flex flex-col justify-between min-h-[280px]">
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#FEB12E] via-[#FFDA94] to-[#FEB12E] z-10" />
              <heroGoal.icon
                size={160}
                strokeWidth={1}
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-xl bg-white/15 backdrop-blur-sm ring-1 ring-[#FEB12E]/60 flex items-center justify-center mb-6">
                ...
                <div className="bg-primary-dark/35 backdrop-blur-sm rounded-xl p-4 max-w-md border-l-2 border-[#FEB12E]">
                  ...
                  <ul className="space-y-1.5">
                    {heroGoal.channels.map((ch) => (
                      <li key={ch} className="flex items-start gap-2 text-white/85 text-xs leading-relaxed">
                        <Check size={13} className="text-[#FEB12E] shrink-0 mt-0.5" />
                        <span>{ch}</span>
                      </li>
                    ))}
                  </ul>
            ...
            {otherGoals.map((g, i) => (
              <FadeUp key={g.title} delay={(i + 1) * 0.1} className="flex-1">
                <div className="bg-white rounded-2xl p-6 h-full card-hover flex items-start gap-4">
                  <div className="w-11 h-11 rounded-xl bg-gradient-hawee ring-2 ring-[#FEB12E]/30 flex items-center justify-center shrink-0">

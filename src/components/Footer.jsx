...
const copy = {
  ...
  en: {
    ...
    sub: 'HAWEE\'s dedicated pavillon within the "HO CHI MINH CITY EXPORT 2026 VIETNAM\'S OUTSTANDING EXPORT PRODUCTS FAIR" — a large-scale annual fair directed by the HCMC Department of Industry and Trade and organized by CSED Center.',
    linksHeading: 'Links',
